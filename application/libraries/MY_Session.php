 ...
 * Modified as OBSession version 2.0.0 by Oscar Bajner, 19 May 2007.
 */
// ------------------------------------------------------------------------
class MY_Session {
...
// ------------------------------------------------------------------------
	...
	function MY_Session()
	{
        ...
        define('OBSESSION_VERSION', '2.0.0');
	...
	function sess_send_session_cookie($force = FALSE)
    {
        ...
        $cookie_expiry = ($cookie_expiry > 0) ? $this->session_length + time() : $cookie_expiry = 0;
