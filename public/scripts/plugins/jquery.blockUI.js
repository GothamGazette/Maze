/*
 * jQuery blockUI plugin Version 2.02 (04/07/2008) @requires jQuery v1.2.3 or
 * later
 * 
...
(function($) {
	...
	$.blockUI.defaults = {
		...
		// suppresses the use of overlay styles on FF/Linux (due to significant
	...
	function install(el, opts) {
		...
		var lyr1 = ($.browser.msie)
				? $('<iframe class="blockUI" style="z-index:1000;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="javascript:false;"></iframe>')
		...
		var lyr3 = full
				? $('<div class="blockUI blockMsg blockPage" style="z-index:1002;position:fixed"></div>')
