...
(function($) {
	...
	function save() {
		// if this is the current source, or it has no title (occurs with click
		// event), stop
		if ($.tooltip.blocked || this == current
	...
	/**
	 * callback for mousemove updates the helper position removes itself when no
	 * current element
	 */
